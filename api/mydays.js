exports.data = function(req, res) {
  var yyyy = req.body.action.params.sys_yyyy;
    ...
    sql.connect(config).then( pool => {
      ...
      .then(result => {
        ...
        if(len === 0){
          ...
          if(!(result.recordset[0].rest_cnt_01 === '')){
          ...
          if(!(result.recordset[0].rest_cnt_06 === '')){
          ...
          if(!(result.recordset[0].rest_cnt_11 === '')){
          ...
          if(!(result.recordset[0].rest_cnt_16 === '')){
          ...
          if(!(result.recordset[0].rest_cnt_21 === '')){
          ...
          if(!(result.recordset[0].rest_cnt_26 === '')){
